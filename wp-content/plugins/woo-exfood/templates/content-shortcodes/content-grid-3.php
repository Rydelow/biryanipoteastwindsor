<?php
  ...
  if(has_excerpt(get_the_ID())){
    ...
    $excerpt = '<div class="exwf-shdes"><p>'.$excerpt.'</p></div>';
  }
?>
  ...
  <div class="exstyle-3-image ex-fly-cart" style="background-image: url(<?php echo get_the_post_thumbnail_url(get_the_ID(),$img_size); ?>)">
    ...
    if($hide_atc!='yes'){?>
      <div class="exbt-inline <?php echo esc_attr($cls_ost); ?>">
        <span href="<?php echo esc_url($customlink); ?>" class="exstyle-3-button"><?php echo $st_stt; ?></span>
      </div>
    <?php }?>
  </div><figcaption>
    ...
    ?>
    <?php if($hide_atc!='yes'){echo '<div class="ex-hidden ex-hdst3">'; exwoofood_booking_button_html(1); echo '</div>';}?>
  </figcaption>
</figure>