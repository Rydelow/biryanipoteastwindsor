...
function exwoofood_shortcode_table( $atts ) {
	...
	<div class="ex-fdlist table-layout <?php echo esc_attr($class); if($live_sort=='1'){ echo ' table-lv-sort';}?>" id ="<?php echo esc_attr($ID);?>">
        ...
        if($menu_filter=="show") {exwoofood_search_form_html($cat,$order_cat,'',$active_filter,$filter_style,$hide_ftall,$show_count);}?>
        <?php 
            ...
            <thead>
                <tr>
                    ...
                    <th class="exp-sort ex-fd-name">
                    	...
                    	<span class="exfd-hide-mb  ex-detail"><?php echo esc_html__('Detail','woocommerce-food');?></span>
                    </th>
