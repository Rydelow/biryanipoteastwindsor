...
function exwoofood_custom_css(){
    ...
    if($exwoofood_font_family!=''){?>
        .ex-fdlist,.exwf-mngroup{font-family: "<?php echo esc_html($main_font_family);?>", sans-serif;}
        <?php
    }
    $exwoofood_font_size = exwoofood_get_option('exwoofood_font_size');
    if($exwoofood_font_size!=''){?>
        .ex-fdlist,.exwf-mngroup{font-size: <?php echo esc_html($exwoofood_font_size);?>;}
        <?php
    }
    $exwoofood_ctcolor = exwoofood_get_option('exwoofood_ctcolor');
    if($exwoofood_ctcolor!=''){?>
    	.ex-fdlist,
        .exfd-table-1 td,.exwf-mngroup{color: <?php echo esc_html($exwoofood_ctcolor);?>;}
        <?php
    }
