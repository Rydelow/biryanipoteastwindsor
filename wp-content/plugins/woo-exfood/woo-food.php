...
class EX_WOOFood{
	...
	function frontend_style(){
		...
		wp_enqueue_script( 'ex-woo-food',plugins_url('/js/food.min.js', __FILE__) , array( 'jquery' ),'2.9' );
		...
		wp_enqueue_script( 'ex-woo-food-ajax-cart',plugins_url('/js/ajax-add-to-cart.min.js', __FILE__) , array( 'jquery','wc-add-to-cart' ),'2.9' );
		wp_register_script( 'exwf-reviews',plugins_url('/js/reviews.js', __FILE__) , array( 'jquery' ),'1.0' );
		wp_register_script( 'exwf-minmax-quantity',plugins_url('/js/minmax-quantity.js', __FILE__) , array( 'jquery' ),'1.0' );
		wp_enqueue_style('ex-woo-food', EX_WOOFOOD_PATH.'css/style.css','2.9');
