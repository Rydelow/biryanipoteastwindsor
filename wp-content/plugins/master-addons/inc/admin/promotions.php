    ...
    class Master_Addons_Promotions
    {
        ...
        public function jltma_latest_update_details()
        {
            ...
            $jltma_changelog_message = sprintf(
                 ...
                 * Starts from: %3$s
                 */
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Security Bugs fixed</span><br>', JLTMA_TD), //%3$s
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Blog Posts Addon updated with Title spacing issue</span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">"MA Duplicator" security bug fixed </span><br>', JLTMA_TD),
                __('<span class="dashicons dashicons-yes"></span> <span class="jltma-changes-list">Warnings on MA Progress Bar issue fixed</span><br>', JLTMA_TD) //%6$s
