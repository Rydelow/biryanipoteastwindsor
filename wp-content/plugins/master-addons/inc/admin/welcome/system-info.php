                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($jltma_memory_limit < 256) {
                                            ...
                                            echo wp_kses_post(sprintf(__('<span>%s - (Min: 256M Recommended).</span> <a href="%2$s" target="_blank">Increasing WP Memory Limit</a>', JLTMA_TD), $jltma_memory_limit, 'https://master-addons.com/elementor-editor-not-loading-issue/'));
                                        } else {
                                            echo wp_kses_post($jltma_valid);
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($jltma_time_limit < 120 && $jltma_time_limit != 0) {
                                                echo wp_kses_post($jltma_invalid);
                                                echo wp_kses_post(sprintf(__('<span> %s - (Min: Recommended 300).</span><a href="%2$s" target="_blank">Increasing WP Time Limit</a>', JLTMA_TD), $jltma_time_limit, 'https://master-addons.com/elementor-editor-not-loading-issue/'));
                                            } else {
                                                echo wp_kses_post($jltma_valid);
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if (!function_exists('curl_init')) {
                                            echo wp_kses_post($jltma_invalid);
                                            echo wp_kses_post('<span>' . __('Not Installed', JLTMA_TD));
                                        } else {
                                            echo wp_kses_post($jltma_valid);
                                            echo wp_kses_post('<span>' . __('Supported', JLTMA_TD));
                                        }
                                        ?>
                                    </td>
                                </tr>
